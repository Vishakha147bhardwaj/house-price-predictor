      ...
      <section className="relative min-h-[88vh] overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[88vh] max-w-7xl flex-col px-5 sm:px-8">
          <nav className="flex items-center justify-between py-7">
            <span className="text-sm font-medium uppercase tracking-[0.35em]">
              Estate <span className="font-display text-lg normal-case italic tracking-normal text-gold">Value</span>
            </span>
            <div className="flex items-center gap-7 text-xs font-medium uppercase tracking-[0.2em] text-ink/70">
          ...
          <div className="flex flex-1 flex-col justify-center py-16">
            ...
            <p className="mt-7 max-w-lg text-base font-normal leading-relaxed text-ink/70 sm:text-lg">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-6">
              ...
              <a href={GITHUB_URL} target="_blank" rel="noreferrer" className="text-xs font-semibold uppercase tracking-[0.2em] text-ink underline-offset-8 hover:underline">
                View the source →
              </a>
            </div>
          </div>
